...
capture.output(s, file = "Gastropods_warm.txt")
...
capture.output(s, file = "Gastropods_cool.txt")
...
#ggsave(file = "gastropods_cool.pdf",cool.p2)
...
#ggsave(file = "gastropods_warm.pdf",warm.p2)
