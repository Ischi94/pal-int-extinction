...
thirteen_trends_gastropods$trend1[is.na(thirteen_trends_gastropods$trend1)] <- 0
thirteen_trends_gastropods$trend2[is.na(thirteen_trends_gastropods$trend2)] <- 0
thirteen_trends_gastropods$trend3[is.na(thirteen_trends_gastropods$trend3)] <- 0

# Split short term temperature change into warming and cooling:
thirteen_trends_gastropods$cooling<-ifelse(thirteen_trends_gastropods$change.prev<0, thirteen_trends_gastropods$change.prev, NA)
thirteen_trends_gastropods$warming<-ifelse(thirteen_trends_gastropods$change.prev>0, thirteen_trends_gastropods$change.prev, NA)

## Warming
# Iterate through each long term temperature change
vars = names(dplyr::select(thirteen_trends_gastropods, trend1:trend3, trend.st1:trend.st10)) 
modelsw4 = lapply(setNames(vars, vars), function(var) {
  form = paste("extinct~warming:", var, "+(1|Genus)")
  glmer(form, data=thirteen_trends_gastropods, family="binomial")
})

# Make data frame for model output
warm_fourteen_trends <- data.frame(model=names(dplyr::select(thirteen_trends_gastropods,
...
capture.output(s, file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Model_summaries/Gastropods_warm.txt")
...
write.table(vis_out_w4$fit, 
            file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Visreg/Gastropods_warm.csv")
...
# Make data frame for model output
cool_fourteen_trends <-data.frame(model=names(dplyr::select(thirteen_trends_gastropods,
                                                            trend1:trend3, trend.st1:trend.st10)), 
                                  intercept=NA, interaction=NA, AIC=NA)
...
capture.output(s, file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Model_summaries/Gastropods_cool.txt")
...
write.table(vis_out_c4$fit, 
            file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Visreg/Gastropods_cool.csv")
...
# Save output as csv
#write.table(warm_fourteen_trends, "modell_summary_Gastropods_w.csv")
#write.table(cool_fourteen_trends, "modell_summary_Gastropods_c.csv")
...
#ggsave(file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/AIC_plots/gastropods_cool.pdf",cool.p2)
...
#ggsave(file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/AIC_plots/gastropods_warm.pdf",warm.p2)
