...
fourteen_trends_echinoderms$trend1[is.na(fourteen_trends_echinoderms$trend1)] <- 0
fourteen_trends_echinoderms$trend2[is.na(fourteen_trends_echinoderms$trend2)] <- 0
fourteen_trends_echinoderms$trend3[is.na(fourteen_trends_echinoderms$trend3)] <- 0
fourteen_trends_echinoderms$trend4[is.na(fourteen_trends_echinoderms$trend3)] <- 0

# Split short term temperature change into warming and cooling:
fourteen_trends_echinoderms$cooling<-ifelse(fourteen_trends_echinoderms$change.prev<0, 
                                            fourteen_trends_echinoderms$change.prev, NA)
fourteen_trends_echinoderms$warming<-ifelse(fourteen_trends_echinoderms$change.prev>0, 
                                            fourteen_trends_echinoderms$change.prev, NA)

## Warming
# Iterate through each long term temperature change
vars = names(dplyr::select(fourteen_trends_echinoderms, trend1:trend4, trend.st1:trend.st10)) 
modelsw4 = lapply(setNames(vars, vars), function(var) {
  form = paste("extinct~warming:", var, "+(1|Genus)")
  glmer(form, data=fourteen_trends_echinoderms, family="binomial")
})

# Make data frame for model output
warm_fourteen_trends <- data.frame(model=names(dplyr::select(fourteen_trends_echinoderms,
                                                             trend1:trend4, trend.st1:trend.st10)), 
...
capture.output(s, file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Model_summaries/Echinoderms_warm.txt")
...
vis_out_w4$fit$ctrend <- ifelse(vis_out_w4$fit$trend.st6<0, "Trend = Cooling", "Trend = Warming")

write.table(vis_out_w4$fit, 
            file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Visreg/Echinoderms_warm.csv")
...
# Make data frame for model output
cool_fourteen_trends <-data.frame(model=names(dplyr::select(fourteen_trends_echinoderms,
                                                            trend1:trend4, trend.st1:trend.st10)), 
                                  intercept=NA, interaction=NA, AIC=NA)
...
capture.output(s, file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Model_summaries/Echinoderms_cool.txt")
...
vis_out_c4$fit$ctrend <- ifelse(vis_out_c4$fit$trend4<0,"Trend = Cooling", "Trend = Warming")

write.table(vis_out_c4$fit, 
            file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/Visreg/Echinoderms_cool.csv")
...
# Save output as csv
#write.table(warm_fourteen_trends, "modell_summary_Echinoderms_w.csv")
#write.table(cool_fourteen_trends, "modell_summary_Echinoderms_c.csv")
...
#ggsave(file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/AIC_plots/echinoderms_cool.pdf",cool.p2)
...
#ggsave(file = "C:/Users/gmath/Documents/4.Semester/Masterarbeit/AIC_plots/echinoderms_warm.pdf",warm.p2)
