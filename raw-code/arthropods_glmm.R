...
fourteen_trends_arthropods$trend1[is.na(fourteen_trends_arthropods$trend1)] <- 0
fourteen_trends_arthropods$trend2[is.na(fourteen_trends_arthropods$trend2)] <- 0
fourteen_trends_arthropods$trend3[is.na(fourteen_trends_arthropods$trend3)] <- 0
fourteen_trends_arthropods$trend3[is.na(fourteen_trends_arthropods$trend3)] <- 0

# Split short term temperature change into warming and cooling:
fourteen_trends_arthropods$cooling<-ifelse(fourteen_trends_arthropods$change.prev<0, 
                                           fourteen_trends_arthropods$change.prev, NA)
fourteen_trends_arthropods$warming<-ifelse(fourteen_trends_arthropods$change.prev>0, 
                                           fourteen_trends_arthropods$change.prev, NA)

## Warming
# Iterate through each long term temperature change
vars = names(dplyr::select(fourteen_trends_arthropods, trend1:trend4, trend.st1:trend.st10)) 
modelsw4 = lapply(setNames(vars, vars), function(var) {
  form = paste("extinct~warming:", var, "+(1|Genus)")
  glmer(form, data=fourteen_trends_arthropods, family="binomial")
})

# Make data frame for model output
warm_fourteen_trends <- data.frame(model=names(dplyr::select(fourteen_trends_arthropods,
...
# Make data frame for model output
cool_fourteen_trends <-data.frame(model=names(dplyr::select(fourteen_trends_arthropods,
                                                            trend1:trend4, trend.st1:trend.st10)), 
                                  intercept=NA, interaction=NA, AIC=NA)
...
# Save output as csv
#write.table(warm_fourteen_trends, "modell_summary_Arthropods_w.csv")
#write.table(cool_fourteen_trends, "modell_summary_Arthropods_c.csv")
