...
capture.output(s, file = "Dinos&Reps_warm.txt")
...
capture.output(s, file = "Dinos&Reps_cool.txt")
...
#ggsave(file = "dinos_cool.pdf",cool.p2)
...
#ggsave(file = "dinos_warm.pdf",warm.p2)
