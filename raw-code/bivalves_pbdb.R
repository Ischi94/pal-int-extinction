...
table(bivalves_pbdb$accepted_rank)
...
bivalves <- fadlad(bivalves_pbdb, tax="genus", age =c("max_ma", "min_ma"))

# transform values back to positive
# bivalves$FAD <- -bivalves$FAD
# bivalves$LAD <- -bivalves$LAD
...
rm(dum1, dum2, i, j, bivalves_pbdb, test, toOmit)
...
thirteen_trends_bivalves <- thirteen_trends_bivalves[-17205,]
